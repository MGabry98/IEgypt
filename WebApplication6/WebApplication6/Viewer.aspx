<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Viewer.aspx.cs" Inherits="WebApplication6.Viewer" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ul>
  <li><a href="ViewerShowInfo">Show info</a></li>
  <li><a href="ViewerEditProfile">Edit profile</a></li>
  <li><a href="User">Logout</a></li>
</ul>
    <p>
          <asp:Label  runat="server" Text="Description: "  Font-Names="Century Gothic"></asp:Label>
           <asp:TextBox ID="txt_desc" runat="server"></asp:TextBox><br>
            <asp:Label  runat="server" Text="Location: "  Font-Names="Century Gothic"></asp:Label>
           <asp:TextBox ID="txt_loc" runat="server"></asp:TextBox><br>
          <asp:Button ID="Button4" runat="server" Text="Create Advertisement" onclick="CreateAd" Font-Names="Showcard Gothic" style="margin-left: 134px"/><br>
          ...
          <asp:Button ID="Button3" runat="server" Text="Deactivate my Account" onclick="Deactivate" Font-Names="Showcard Gothic" style="margin-left: 134px"/><br>
