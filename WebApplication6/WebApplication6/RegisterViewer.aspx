<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterViewer.aspx.cs" Inherits="WebApplication6.Register" %>
...
<body>
 ...
 <!-- <li><a href="highlight.html">Highlight</a></li>
  <li><a href="about.html">About</a></li> -->
            ...
            <asp:TextBox ID="txt_working_place" runat="server"></asp:TextBox><br>
            <asp:Label ID="Label1" runat="server" Text="Working place type: "  Font-Names="Century Gothic"></asp:Label>
            <asp:TextBox ID="txt_working_place_type" runat="server"></asp:TextBox><br>
            <asp:Label ID="Label9" runat="server" Text="Working Place description: "  Font-Names="Century Gothic"></asp:Label>
            <asp:TextBox ID="txt_working_place_des" runat="server"></asp:TextBox><br>

            <asp:Button ID="btn_register" runat="server" Text="Register" onclick="RegisterViewer" Font-Names="Showcard Gothic" style="margin-left: 134px"/><br>
                </p>
            <br>
