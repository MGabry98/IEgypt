<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterContributor.aspx.cs" Inherits="WebApplication6.RegisterContributor" %>
...
<body>
 ...
 <!-- <li><a href="highlight.html">Highlight</a></li>
  <li><a href="about.html">About</a></li> -->
            ...
            <h1>Register as Contributor</h1><br>
            <p>
            ...
            <asp:Label ID="Label8" runat="server" Text="Years of experience: "  Font-Names="Century Gothic"></asp:Label>
            <asp:TextBox type="number" ID="txt_years_exp" runat="server"></asp:TextBox><br>
            <asp:Label ID="Label1" runat="server" Text="Portofolio link: "  Font-Names="Century Gothic"></asp:Label>
            <asp:TextBox ID="txt_portofolio_link" runat="server"></asp:TextBox><br>
            <asp:Label ID="Label9" runat="server" Text="Specialization: "  Font-Names="Century Gothic"></asp:Label>
            <asp:TextBox ID="txt_specialization" runat="server"></asp:TextBox><br>

            <asp:Button ID="btn_register" runat="server" Text="Register" onclick="RegisterCont" Font-Names="Showcard Gothic" style="margin-left: 134px"/><br>
                </p>
            <br>
