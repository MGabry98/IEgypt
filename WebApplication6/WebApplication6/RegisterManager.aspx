<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterManager.aspx.cs" Inherits="WebApplication6.RegisterStaff" %>
...
<body>
 ...
 <!-- <li><a href="highlight.html">Highlight</a></li>
  <li><a href="about.html">About</a></li> -->
             ...
             <h1>Register as Content Manager</h1><br>
            <p>
            ...
            <asp:Button ID="btn_register" runat="server" Text="Register" onclick="RegisterManager" Font-Names="Showcard Gothic" style="margin-left: 134px"/><br>
                </p>
            <br>
