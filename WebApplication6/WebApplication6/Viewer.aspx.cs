...
namespace WebApplication6
{
    public partial class Viewer : System.Web.UI.Page
    {
        ...
        protected void CreateAd(object sender, EventArgs e)
        {
            ...
            cnn.Open();
            string descr = txt_desc.Text;
            string loc = txt_loc.Text;
            int viewerid = Convert.ToInt32(Session["ID"].ToString());
            ...
            cmd.ExecuteNonQuery();
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Ad created" + "');", true);
